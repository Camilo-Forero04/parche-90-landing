'use client';
// 👇 Ya no necesitamos FaWhatsapp ni next/image, así que borra esas importaciones 👇
    ...
    return (
        <a
            ...
            style={{
                ...
                cursor: 'pointer',
                textDecoration: 'none', // Para que no se subraye
            }}
            onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.1)'}
            onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}
        >
            {/* 👇 ESTE ES EL SVG NATIVO QUE REMPLAZA AL ICONO ROTO 👇 */}
            <svg
                viewBox="0 0 448 512"
                style={{
                    height: '35px',
            ...
            {/* Mantengo tu puntito rojo de notificación */}
            <span style={{
                position: 'absolute',
                top: '-5px',
                right: '-5px',
