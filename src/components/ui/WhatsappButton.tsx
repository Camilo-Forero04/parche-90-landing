...
export default function WhatsAppButton() {
    ...
    return (
        <a
            ...
            className="fixed bottom-[30px] right-[30px] z-[9999] flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_rgba(37,211,102,0.4)] transition-transform duration-300 hover:scale-110 active:scale-95"
            aria-label="Chat con Parche 90"
        >
            {/* 👇 SVG Nativo: Cero peticiones extra, cero JS */}
            <svg
                viewBox="0 0 448 512"
            ...
            <span className="absolute -right-1 -top-1 h-[15px] w-[15px] rounded-full border-2 border-[#060606] bg-[#FF0000]"></span>
        </a>
    );
}